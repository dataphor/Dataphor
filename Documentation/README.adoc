...
[horizontal]
<<./UsersGuide/UsersGuide.adoc, User's Guide>>:: Introduces Dataphor and provides usage guidance.
+
...
<<./DevelopersGuide/DevelopersGuide.adoc, Developer's Guide>>::
...
<<./DataphorReference/DataphorReference.adoc, Dataphor Reference>>::
