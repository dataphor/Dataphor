...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="namespace" mode="namespacefull">
        ...
        <sect1>
            ...
            <xsl:if test="./class[not(./documentation/nodoc)]">
                <xsl:for-each select="./class[not(./documentation/nodoc)]">
                    <sect2>
            ...
            <xsl:if test="./interface[not(./documentation/nodoc)]">
                <xsl:for-each select="./interface[not(./documentation/nodoc)]">
                    <sect2>
                        <xsl:apply-templates select="."/>
                        <xsl:apply-templates select="." mode="process-members"/>
                        <xsl:apply-templates select="." mode="process-individuals"/>
            ...
            <xsl:if test="./structure[not(./documentation/nodoc)]">
                <xsl:for-each select="./structure[not(./documentation/nodoc)]">
                    <sect2>
                        <xsl:apply-templates select="."/>
                        <xsl:apply-templates select="." mode="process-members"/>
                        <xsl:apply-templates select="." mode="process-individuals"/>
            ...
            <xsl:if test="./delegate[not(./documentation/nodoc)]">
                <xsl:for-each select="./delegate[not(./documentation/nodoc)]">
                    <sect2>
                        <xsl:apply-templates select="."/>
                        <xsl:apply-templates select="." mode="process-members"/>
                        <xsl:apply-templates select="." mode="process-individuals"/>
            ...
            <xsl:if test="./enumeration[not(./documentation/nodoc)]">
                <xsl:for-each select="./enumeration[not(./documentation/nodoc)]">
                    <sect2>
                        <xsl:apply-templates select="."/>
