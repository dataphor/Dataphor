...
<!-- ********************************************************************
     $Id: param.xweb,v 1.81 2004/08/26 18:58:42 bobstayton Exp $
     ********************************************************************
...
<xsl:param name="page.margin.inner">
  ...
  -->
  <xsl:choose>
    <xsl:when test="$double.sided != 0">0.8in</xsl:when>
...
<xsl:param name="page.margin.outer">
  ...
  -->
  <xsl:choose>
    <xsl:when test="$double.sided != 0">0.4in</xsl:when>
    <xsl:otherwise>0.6in</xsl:otherwise>
  </xsl:choose>
</xsl:param>
<xsl:param name="page.margin.top" select="'0.3in'"/>
