...
<<D4Catalog.adoc#Scalar_Types, System.Scalar>>::
...
<<D4Catalog.adoc#Conversions, Conversions>>.
...
<<D4Catalog.adoc#Scalar_Types, Scalar Types>> |
<<../DataphorReference.adoc#Scalar_Types, Dataphor Reference, Scalar Types>>
...
<<D4Catalog.adoc#Table_Variables, Table Variables>>
...
<<Indexer_Expression, Indexer Expressions>>
...
<<D4DataManipulation.adoc#Cursor_Type, Cursor Type>>
...
of special operators called __<<D4Catalog.adoc#Selector, selectors>>__.
<<D4LexicalElements.adoc#Parser_Literals, Parser Literals>>
...
<<ModelingProcessLogic.adoc#Using_Rows, Using Rows>>.
...
<<ModelingProcessLogic.adoc#Using_Lists, Using Lists>>.
...
cursors, see
<<ModelingProcessLogic.adoc#Using_Cursors, Using Cursors>>.
...
have been called
__<<D4Catalog.adoc#Table_Variables, table variables>>__
...
<<D4ImperativeStatements.adoc#Variable_Declaration_Statement, Variable declaration>>
...
_uninitialized_ or __<<Nil_Semantics, nil>>__.
...
see <<D4LexicalElements.adoc#Identifiers, Identifiers>>.
...
<<D4ImperativeStatements.adoc#Variables, Variables>>
...
Like <<Expressions, expressions>>, every D4
...
__<<Nil_Semantics, nil>>__, or no value, at run-time.
...
<<D4Catalog.adoc#Operators, Catalog Elements, Operators>>
...
<<D4Catalog.adoc#Summary, Catalog Elements>>.
...
<<D4DataManipulation.adoc#Summary, Data Manipulation>>.
...
discussed in detail in <<D4ImperativeStatements.adoc#Summary, Imperative>>.
...
see <<D4ImperativeStatements.adoc#Summary, Imperative Statements>>.

[[D4LGLanguageElements-Expressions]]
== Expressions

A D4 expression is a statement that returns a result. This includes
<<Parser_Literals, parser literals>>
and <<Operator_Invocation, operator invocations>>. The result of
evaluating any given expression is either a value or
__<<Nil_Semantics, nil>>__. Expressions are built according to
the <expression> production rule. The following are examples of valid D4 expressions.
...
Just like <<Operators, operators>>, every D4
...
__<<Nil_Semantics, nil>>__. In general, expressions are nilable
...
rule see <<D4TableOperators.adoc#Summary, Table Operators>>.
...
<<D4LexicalElements.adoc#Identifiers, Identifiers>>.
...
<<D4Catalog.adoc#Summary, Scalar Types>>.
...
Each <<D4Catalog.adoc#Operators, operand>> in the signature
...
_<<D4ImperativeStatements.adoc#If_Statement, if>> expression_
and the __<<D4ImperativeStatements.adoc#Case_Statement, case>> expression__.
...
<<D4ImperativeStatements.adoc#Case_Statement, case statement>> |
<<D4ImperativeStatements.adoc#If_Statement, if statement>> |
<<Expressions, Expressions>>
