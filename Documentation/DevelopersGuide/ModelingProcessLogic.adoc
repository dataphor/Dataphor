...
<<ImplementingDataTypes.adoc#Summary, Implementing Data Types>>
...
<<D4LanguageElements.adoc#Row_Values, row values>>.
...
<<D4LanguageElements.adoc#Row_Types, row type>>.
...
Row Update:: Row <<D4DataManipulation.adoc#Update_Statement, update>> allows the
...
....
Row Redefine:: Row <<D4TableOperators.adoc#Redefine, redefine>> allows columns
...
<<RepresentingData.adoc#Summary, Representing Data with Tables and Views>>.
...
<<D4DataManipulation.adoc#Cursor_Capabilities, cursor capabilities>>
...
<<ImplementingDataTypes.adoc#Host-implemented_Types_and_Operators, Host-Implemented Types and Operators>>
...
<<D4LanguageElements.adoc#Operator_Precedence, Operator Precedence>>
...
<<D4Catalog.adoc#Operator_Resolution, Operator Resolution>>
in the D4 Language Guide.
...
<<DatabaseManagementConcepts.adoc#Transaction_Management, Transaction Management>>
...
refer to
<<SpaceBetweenData.adoc#Application_Transactions, Application Transactions>>
...
<<Dynamic_Execution, Dynamic Execution>> section.
...
interfaces, refer to
<<PuttingItAllTogether.adoc#Invoice_Management, Invoice Management>>
in the Presentation Layer part of this guide.
