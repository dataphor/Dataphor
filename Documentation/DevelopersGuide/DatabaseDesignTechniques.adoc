...
Principle of Orthogonal Design:: The Principle of Orthogonal Design basically states that within a given
...
[9].
Principle of Cautious Design:: The Principle of Cautious Design is a general guideline, not just for
...
Database Design:: Obviously, this topic is extremely broad, but a particularly concise and
...
Normalization Theory:: Perhaps the best introduction to normalization theory can be found in An
...
issues.
Temporal Data:: As mentioned in the section on temporal data, the book Temporal Data and
