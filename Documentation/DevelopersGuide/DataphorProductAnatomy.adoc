...
<<D4Catalog.adoc#Summary, Catalog Elements>> section of the D4
Language Guide in this manual.

For more information on using these elements to construct a Dataphor
Application, refer to the <<LogicalApplicationDesign.adoc#Summary, Logical Application Design]>>
part of this manual.

For more information on the security system of the Dataphor Server,
refer to the <<../UsersGuide/Security.adoc#Summary, Security>> chapter of the Dataphor
User's Guide.
