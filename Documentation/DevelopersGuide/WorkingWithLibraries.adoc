...
<<../UsersGuide/DataphoriaLibraries.adoc#Summary, __available__, __registered__, or __suspect__>>.
...
<<../UsersGuide/DataphoriaLibraries.adoc#Upgrading_Libraries, Upgrading libraries>>
is accomplished by <<Versioning, versioning>> the
