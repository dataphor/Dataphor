...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!-- ATTRIBUTES -->
    <!-- todo: convert this to something saxon can do, otherwise cannot suppport selecting attributes/properties to document -->
    <!--
	<saxon:script implements-prefix="user" language="java" src="java:com.icl.saxon.functions.Extensions">
	<![CDATA[
	...
	<xsl:template name="attribute">
        ...
        <!-- until fix user namespace in saxon, must assume want all attributes
