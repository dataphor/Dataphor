...
namespace Alphora.Dataphor.FHIR.API
{
	...
	public class GetByKeyNode : InstructionNode
	{
		public override void DetermineDataType(Plan plan)
		{
			...
			var tableVar = APIUtilities.ResolveTableVarName(plan, tableVarName);
	...
	public class GetNode : InstructionNode
	{
		...
		public override object InternalExecute(Program program, object[] arguments)
		{
			...
			return APIUtilities.Evaluate(program, expression, tableVar, null);
		}
	}
