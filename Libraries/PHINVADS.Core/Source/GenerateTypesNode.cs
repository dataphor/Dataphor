...
namespace Alphora.Dataphor.PHINVADS.Core
{
	public class GenerateTypesNode : InstructionNode
	{
		...
		private void MapPrimitiveTypeNames()
		{
			...
			_typeNameMap.Add("System.Double", "Decimal"); // Isn't necessarily accurate... will need marshalling to handle the conversion
			_typeNameMap.Add("System.Uri", "String"); // Map Uri to string
			_typeNameMap.Add("System.Byte[]", "Binary");
			_typeNameMap.Add("System.Object", "generic");
		}
