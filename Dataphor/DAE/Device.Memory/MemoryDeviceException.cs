...
namespace Alphora.Dataphor.DAE.Device.Memory
{
	public class MemoryDeviceException : DeviceException
	{
		...
		public MemoryDeviceException(System.Runtime.Serialization.SerializationInfo AInfo, System.Runtime.Serialization.StreamingContext AContext) : base(AInfo, AContext) {}
	}
}