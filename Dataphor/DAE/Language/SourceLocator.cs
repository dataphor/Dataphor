...
{
	/// <summary>
	/// Represents a source locator used to specify the originating location for the source text of a compiled plan.
	/// </summary>
	[Serializable]
	public class SourceLocator
	{
		/// <summary>
		/// Constructs a new SourceLocator instance.
		/// </summary>
		...
		public SourceLocator(string ALocator, int ALine, int ALinePos) : base()
		{
			FLocator = ALocator;
			FLine = ALine;
			FLinePos = ALinePos;
		...
		/// <summary>
		/// Constructs a new SourceLocator based on a source locator and current line information.
		/// </summary>
		...
		public SourceLocator(SourceLocator ALocator, int ALine, int ALinePos) : base()
		{
		...
		public static SourceLocator Parse(string AValue)
		{
		...
		/// </summary>
		//public static SourceLocator Dynamic = new SourceLocator("DYNAMIC", 1, 1);

		public override bool Equals(object AOther)
		{
			SourceLocator LOther = AOther as SourceLocator;
		...
		public static bool operator ==(SourceLocator ALeft, SourceLocator ARight)
		{
