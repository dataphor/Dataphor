...
namespace Alphora.Dataphor.DAE.Language.SQL
{
	...
	*/
    ...
    {
		// ViewSchema
		protected string _viewSchema = String.Empty;
		public string ViewSchema
		{
			get { return _viewSchema; }
			set { _viewSchema = value == null ? String.Empty : value; }
		}
		
		// ViewName
		protected string _viewName = String.Empty;
		public string ViewName
		{
			get { return _viewName; }
			set { _viewName = value == null ? String.Empty : value; }
		}
    ...
    public class AlterViewStatement : Statement
    {
		// ViewSchema
		protected string _viewSchema = String.Empty;
		public string ViewSchema
