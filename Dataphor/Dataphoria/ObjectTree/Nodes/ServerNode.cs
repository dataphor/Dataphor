...
namespace Alphora.Dataphor.Dataphoria.ObjectTree.Nodes
{
	public class ServerNode : DataNode
	{
		...
		protected override ContextMenu GetContextMenu()
		{
			...
			LMenu.MenuItems.Add(FDisconnectMenuItem = new MenuItem(Strings.DisconnectMenuText, new EventHandler(DisconnectClicked)));
			LMenu.MenuItems.Add(FViewLogMenuItem = new MenuItem(Strings.ViewLogMenuText, new EventHandler(ViewLogClicked)));
			LMenu.MenuItems.Add(new MenuItem("-"));
			LMenu.MenuItems.Add(FNewDesignerMenuItem = new MenuItem(Strings.NewDesignerMenuText, new EventHandler(NewDesignerClicked)));
			LMenu.MenuItems.Add(FOpenFileMenuItem = new MenuItem(Strings.OpenFileMenuText, new EventHandler(OpenFileClicked)));
			LMenu.MenuItems.Add(FOpenFileWithMenuItem = new MenuItem(Strings.OpenFileWithMenuText, new EventHandler(OpenFileWithClicked)));
			LMenu.MenuItems.Add(new MenuItem("-"));
			...
			LMenu.MenuItems.Add(FUpgradeLibrariesMenuItem = new MenuItem(Strings.UpgradeLibrariesMenuText, new EventHandler(UpgradeLibrariesClicked)));
			return LMenu;
		}
