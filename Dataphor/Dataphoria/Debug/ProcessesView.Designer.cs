namespace Alphora.Dataphor.Dataphoria
{
	partial class ProcessesView
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ProcessesView));
			this.FProcessDataView = new Alphora.Dataphor.DAE.Client.DataView(this.components);
			...
			this.FProcessSource = new Alphora.Dataphor.DAE.Client.DataSource(this.components);
			...
			((System.ComponentModel.ISupportInitialize)(this.FProcessDataView)).BeginInit();
			...
			// FProcessDataView
			// 
			this.FProcessDataView.Expression = resources.GetString("FProcessDataView.Expression");
			this.FProcessDataView.IsReadOnly = true;
			this.FProcessDataView.RequestedCapabilities = ((Alphora.Dataphor.DAE.CursorCapability)((((Alphora.Dataphor.DAE.CursorCapability.Navigable | Alphora.Dataphor.DAE.CursorCapability.BackwardsNavigable)
						| Alphora.Dataphor.DAE.CursorCapability.Bookmarkable)
						| Alphora.Dataphor.DAE.CursorCapability.Searchable)));
			this.FProcessDataView.SessionName = "";
			this.FProcessDataView.DataChanged += new System.EventHandler(this.FSessionDataView_DataChanged);
			// 
			// dbGrid1
			// 
			...
			this.dbGrid1.Source = this.FProcessSource;
			...
			// FProcessSource
			// 
			this.FProcessSource.DataSet = this.FProcessDataView;
			// 
			// toolStripContainer1
			// 
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.FProcessDataView)).EndInit();
		...
		private Alphora.Dataphor.DAE.Client.DataView FProcessDataView;
		private Alphora.Dataphor.DAE.Client.Controls.DBGrid dbGrid1;
		private Alphora.Dataphor.DAE.Client.DataSource FProcessSource;
